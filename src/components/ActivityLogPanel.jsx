            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-3 no-scrollbar">
              {loading && logs.length === 0 ? (
                ...
                logs.map((log) => (
                  <div
                    key={log.id}
                    className="p-3.5 bg-white rounded-xl border-l-6 border-muted shadow-sm transition-all flex flex-col gap-1"
                  >
                    <div className="flex justify-between items-center gap-1">
                      <div className="flex items-center gap-2 min-w-0">
                        <span className="font-semibold md:text-sm text-xs text-[#25252a] truncate">
                    ...
                    {log.task_title && (
                      <div className="text-xs font-code text-[#1E1E24] break-words">
                        {log.task_title}
                      </div>
                    )}
                  </div>
