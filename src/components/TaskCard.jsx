  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={`relative z-10 flex justify-between gap-2 rounded-[32px] bg-[#222222] p-5 text-white shadow-xl transition-all duration-200 w-[340px] h-[193px] border-l-8 ${accentTheme.borderColorClass} ${
