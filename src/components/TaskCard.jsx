...
const CATEGORY_THEME = {
  overdue: {
    ...
    bgAccent: "bg-[#CF0003]",
    borderLeftClass: "sm:border-l-[#CF0003]",
  },
  today: {
    text: "text-[#8EA824]",
    ...
    bgAccent: "bg-[#B0E01E]",
    borderLeftClass: "sm:border-l-[#B0E01E]",
  },
  upcoming: {
    text: "text-[#008ACF]",
    ...
    bgAccent: "bg-[#008ACF]",
    borderLeftClass: "sm:border-l-[#008ACF]",
  },
  none: {
    text: "text-[#A06E32]",
    ...
    bgAccent: "bg-[#FFC684]",
    borderLeftClass: "sm:border-l-[#FFC684]",
  },
};
  ...
  return (
    <>
      ...
      >
        ...
        {/* MAIN CARD CONTAINER */}
        <div
          className={`relative z-10 flex flex-col justify-between rounded-3xl ml-3 sm:ml-0 pl-5 pr-5 py-4 sm:p-5 text-white shadow-xl transition-all duration-200 min-h-[110px] sm:min-h-0 sm:h-48.25 sm:w-82 bg-[#2A2A2A] sm:bg-[#1E1E23] sm:rounded-4xl sm:pl-5 sm:pr-4 sm:border-l-8 ${accentTheme.borderLeftClass} ${
            task.completed ? "opacity-60" : "opacity-100"
          }`}
        >
          {/* MOBILE VIEW: VERTICAL TOP/MIDDLE/BOTTOM STRUCTURE */}
          <div className="flex sm:hidden flex-col justify-between h-full gap-2">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-2 min-w-0 flex-wrap">
                <h3
                  className={`text-xl font-bold font-afacad truncate max-w-[150px] ${
            ...
            <p
              className={`text-base font-afacad font-normal line-clamp-2 my-1 ${
          ...
          {/* DESKTOP VIEW: ORIGINAL HORIZONTAL LAYOUT (LEFT CONTENT + RIGHT ACTION COLUMN) */}
          <div className="hidden sm:flex justify-between gap-2 h-full">
            <div className="flex flex-col justify-between flex-1 min-w-0">
              <div>
                <div className="flex items-center gap-2 min-w-0 mb-2">
                  <h3
                    className={`text-xl font-bold font-afacad truncate ${
                      task.completed ? "text-gray-300" : "text-white"
                    }`}
                  >
                    {task.task}
                ...
                <p
                  className={`text-lg font-afacad font-normal line-clamp-2 ${
                    task.completed ? "text-gray-400" : "text-gray-300"
                  }`}
                >
                  {task.des || "description description description"}
