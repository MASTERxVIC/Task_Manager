  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={`relative z-10 flex justify-between gap-2 rounded-4xl bg-[#222222] px-3.75 py-4 text-white shadow-xl transition-all duration-200 w-84 h-48.25 border-l-8 ${accentTheme.borderColorClass} ${
