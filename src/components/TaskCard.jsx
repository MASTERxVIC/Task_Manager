  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`relative z-10 flex justify-between gap-2 rounded-4xl bg-[#1E1E23] pl-5 pr-4 py-5 text-white shadow-xl transition-all duration-200 w-82 h-48.24 border-l-8 ${accentTheme.borderColorClass} ${
