    ...
    <div className="sticky top-0 z-20 bg-[#1E1E24] backdrop-blur border-b border-line px-3 sm:px-8 py-3.5 sm:py-4">
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {hasTasks && (
          <button
            onClick={onClearAll}
            className="shrink-0 inline-flex items-center font-semibold text-[#1E1E24] bg-[#FDFBF7] hover:text-coral border border-[#FDD739] text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-xl  hover:opacity-90 transition-opacity whitespace-nowrap cursor-pointer"
          >
            Clear all
          </button>
        )}
        ...
        <button
          onClick={onAddClick}
          className="shrink-0 inline-flex items-center gap-1 sm:gap-1.5 bg-[#FDD739] text-[#1E1E24] font-semibold text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-xl hover:opacity-90 transition-opacity whitespace-nowrap cursor-pointer"
        >
