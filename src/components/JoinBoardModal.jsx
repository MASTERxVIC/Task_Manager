            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                <button
                  ...
                  onClick={handleClose}
                  disabled={loading}
                  className="px-4 py-2 text-sm text-gray-300 border border-rose-800 hover:text-white hover:bg-rose-800 hover:border-0 rounded-xl transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
