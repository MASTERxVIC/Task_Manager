      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-between p-8 sm:p-14 overflow-y-auto no-scrollbar z-10 relative">
        ...
        <div className="max-w-md w-full mx-auto my-auto space-y-6">
          ...
          <div className="space-y-1.5">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#1E1E24]">
          ...
          <div className="relative flex items-center justify-center my-2">
            ...
            <span className="bg-[#FDFBF7] px-3 text-[11px] font-medium text-gray-400 uppercase tracking-widest absolute">or</span>
          </div>
